...
<body class="voyager @if (isset($dataType) && isset($dataType->slug)) {{ $dataType->slug }} @endif">
                ...
                <div class="side-body padding-top">
                    ...
                    ">
                        ...
                        ">
                            ...
                            ">
                                ...
                                margin-bottom: 10px;
                            ">
                                    Su servicio finaliza @if ($aux->payment_alert() == 0)
                                        el día de hoy.
                                    @else
                                        en <strong>{{ $aux->payment_alert() }} días.
                                    @endif
                                    </strong>
                                </p>
                            ...
                            ">
                                    <div style="display: flex; gap: 10px; flex-wrap: wrap;">
                                        <div style="flex: 1; min-width: 120px;">
                                            <p
                                                style="font-weight: 600; margin: 0 0 3px 0; font-size: 13px; color: #333;">
                                                📞 Teléfono</p>
                                        ...
                                        <div style="flex: 1; min-width: 120px;">
                                            <p
                                                ...
                                                ✉️ Email</p>
                                            <p style="margin: 0; font-size: 12px; color: #555;">
                                                {{ $solucionDigital->where('key', 'contact.email')->first()->value }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div style="display: flex; gap: 10px; margin-top: 10px;">
                                    <a href="https://wa.me/{{ $solucionDigital->where('key', 'contact.phone')->first()->value }}"
                                        target="_blank"
                                        style="
                    ...
                    <div class="hover-container">
                        <div class="hover-trigger">
                            <img src="{{ asset('images/billeteraDigital.png') }}"
                                style="width: 35px; height: 30px; border-radius: 35px;">
                        </div>
    ...
    @if (setting('configuracion.navidad'))
        ...
        <script type="text/javascript">
            $(function() {
                $(document).snow({
                    SnowImage: "{{ asset('navidad/image/icon.png') }}",
                    SnowImage2: "{{ asset('navidad/image/caramelo.png') }}"
                });
            });
        </script>
    @endif
